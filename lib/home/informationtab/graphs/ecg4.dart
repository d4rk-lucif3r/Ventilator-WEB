...
class GraphECG4 extends StatelessWidget {
  const GraphECG4({
    Key? key,
...
class ECG4Graph extends StatefulWidget {
  const ECG4Graph({
    Key? key,
    required this.provider,
    this.enableDefault,
  ...
  @override
  _ECG4GraphState createState() => _ECG4GraphState();
}

class _ECG4GraphState extends State<ECG4Graph> {
  ...
  List<LineSeries<ChartData, num>> _getDefaultSplineSeries(ECG4 provider) {
